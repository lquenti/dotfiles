...
-- Config directory
local rc_lua_dir = gears.filesystem.get_configuration_dir()
...
beautiful.init("~/.config/awesome/themes/ExSi/theme.lua")
...
-- CPU
cpu_widget = require("gitrepos.awesome-wm-widgets.cpu-widget.cpu-widget")

-- RAM
ram_widget = require("gitrepos.awesome-wm-widgets.ram-widget.ram-widget")

-- Spotify
local spotify_widget = require("gitrepos.awesome-wm-widgets.spotify-widget.spotify")
...
local function set_wallpaper(s)
    ...
    -- Uncomment this to use the themes wallpaper
    -- -- Wallpaper
