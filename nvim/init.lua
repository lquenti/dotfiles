...
-- MIT https://github.com/nvim-lua/kickstart.nvim
...
-- Disable <Space> for normal and visual (otherwise a move-right)
...
require('which-key').register({
  ...
  ['<leader>g'] = { name = '[G]it (previously, TODO RENAME)', _ = 'which_key_ignore' },
...
-- Stuff I havent yet ported from vimscript
vim.cmd([[
